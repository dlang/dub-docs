...
## SYNOPSIS
<b>dub remove-local </b>&lt;<i>path</i>&gt; <i>OPTIONS...</i>
## DESCRIPTION
...
<dt id="option-remove-local---b---system-b-" class="option-argname">
<a class="anchor" href="#option-remove-local---b---system-b-"></a>
...
## SEE ALSO
[<b>dub</b>(1)](dub.md), [<b>dub-add-local</b>(1)](dub-add-local.md)
